...
public class EndReplyPageBrowserDataRecorder implements IBasicCommand {
	private static final Logger logger = LogManager.getLogger( EndReplyPageBrowserDataRecorder.class );
