...
public class BeginTimelineBrowserDataRecorder implements IBasicCommand {
	private static final Logger logger = LogManager.getLogger( BeginTimelineBrowserDataRecorder.class );
