...
public class TestCreateLoginToSite implements IIfCommand {
	private static final Logger logger = LogManager.getLogger( TestCreateLoginToSite.class );

	public TestCreateLoginToSite() {
	}
	...
	public boolean test( IProduct product, IEnvironment env, Object extra, int index ) throws Exception {
		...
		return searchRunBaseData.isUsingLogin() && !searchRunBaseData.isSkipLogin();
	}
}
