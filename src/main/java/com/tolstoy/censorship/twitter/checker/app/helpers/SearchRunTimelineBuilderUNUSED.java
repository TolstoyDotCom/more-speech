 ...
 */
final public class SearchRunTimelineBuilderUNUSED /*implements IBrowserProxyResponseListener*/ {
	private static final Logger logger = LogManager.getLogger( SearchRunTimelineBuilderUNUSED.class );
	...
	public SearchRunTimelineBuilderUNUSED( final IResourceBundleWithFormatting bundle,
